...
params <- list(
  ...
  eval_metric = "auc",
  eta = 0.05,           # Slightly lower than 0.1
  max_depth = 7,        # Slightly deeper than 6  
  min_child_weight = 2, # Slightly more than 1
  subsample = 0.8,
...
print(paste("Best XGBoost CV AUC:", xgb_cv$evaluation_log$test_auc_mean[xgb_cv$best_iteration]))
...
# 3. Ensemble (Average)
ensemble_predictions <- logistic_predictions * 0.4 + xgb_predictions * 0.6
