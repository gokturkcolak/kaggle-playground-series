...
Q1_debt_to_income_ratio <- quantile(train$debt_to_income_ratio, 0.25)
Q3_debt_to_income_ratio <- quantile(train$debt_to_income_ratio, 0.75)
IQR_debt_to_income_ratio <- IQR(train$debt_to_income_ratio)

lower_bound_debt_to_income_ratio <- Q1_debt_to_income_ratio - 1.5 * IQR_debt_to_income_ratio
upper_bound_debt_to_income_ratio <- Q3_debt_to_income_ratio + 1.5 * IQR_debt_to_income_ratio

# Filter out outliers
train_clean <- train %>%
  filter(debt_to_income_ratio >= lower_bound_debt_to_income_ratio & debt_to_income_ratio <= upper_bound_debt_to_income_ratio)
